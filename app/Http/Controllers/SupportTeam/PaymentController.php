...
class PaymentController extends Controller
{
    ...
    public function create()
    {
        ...
        $payController = new PaymentController($this->my_class, $this->pay,  $this->student); // Pass the required repositories
        $payData = $payController->index();
        $manageData = $payController->manage();

        // Merge
        $d = array_merge($d, $payData, $manageData);
