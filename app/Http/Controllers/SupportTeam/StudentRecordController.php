...
class StudentRecordController extends Controller
{
   ...
   public function __construct(LocationRepo $loc, MyClassRepo $my_class, UserRepo $user, StudentRepo $student)
   {
    ...
    public function create()
    {
        ...
        $promotionController = new PromotionController($this->my_class, $this->student);
        $promotionData = $promotionController->getPromotionData(request());

        // Fetch the management data using the manage() method from PromotionController
        $managementData = $promotionController->manage();

        // Merge the promotion data and management data with other data
        $data = array_merge($data, $promotionData, $managementData);
