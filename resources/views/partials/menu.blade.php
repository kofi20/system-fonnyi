                ...
                @if (Qs::userIsAdministrative())
                    <li class="nav-item ">
                        <a href="{{ route('payments.create') }}"
                            class="nav-link {{ Route::is('payments.create') ? 'active' : '' }}"><i
                                class="icon-office"></i> <span> Payments</span></a>
                ...
                @if (Qs::userIsTeamSAT())
                    <li class="nav-item">
                        <a href="{{ route('students.create') }}"
                            class="nav-link {{ Route::is('students.create') ? 'active' : '' }}"><i
                ...
                @if (Qs::userIsTeamSAT())
                    <li class="nav-item">
                        <a href="{{ route('exams.index') }}"
                            class="nav-link {{ Route::is('exams.index') ? 'active' : '' }}"><i class="icon-books"></i>
                            <span> Exams</span></a>
