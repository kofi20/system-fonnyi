...
@section('content')
    ...
    <div class="payment">
        ...
        <ul class="nav nav-tabs nav-tabs-highlight">
            <li class="nav-item"><a href="#create" class="nav-link active" data-toggle="tab">Create Payment</a></li>
            <li class="nav-item"><a href="#manage" class="nav-link" data-toggle="tab">Manage Payments</a></li>
            <li class="nav-item"><a href="#student" class="nav-link" data-toggle="tab">Student Payments</a></li>
        </ul>
        ...
        <div class="tab-content">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <form class="ajax-store" method="post" action="{{ route('payments.store') }}">
                                    ...
                                    <div class="form-group row">
                                        <label for="my_class_id" class="col-lg-3 col-form-label font-weight-semibold">Class
                                        </label>
                                        <div class="col-lg-9">
                                    ...
                                    <div class="form-group row">
                                        <label for="amount" class="col-lg-3 col-form-label font-weight-semibold">Amount
                                            (<del style="text-decoration-style: double">N</del>) <span
                                                class="text-danger">*</span></label>
                                        <div class="col-lg-9">
            ...
            <div class="tab-pane fade" id="manage">
                @include('pages.support_team.payments.index')
            </div>

            {{-- student Payments --}}
            <div class="tab-pane fade" id="student">
                @include('pages.support_team.payments.manage')
            </div>
        </div>
    </div>
