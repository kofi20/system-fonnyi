...
@section('content')
    ...
    <div class="card">
        ...
        <ul class="nav nav-tabs nav-tabs-highlight">
            <li class="nav-item"><a href="#cl" class="nav-link active" data-toggle="tab">Classes</a></li>
            <li class="nav-item"><a href="#sec" class="nav-link" data-toggle="tab">Sections</a></li>
            <li class="nav-item"><a href="#sub" class="nav-link" data-toggle="tab">Subjects</a></li>
            <li class="nav-item"><a href="#dorm" class="nav-link" data-toggle="tab">Dormitories</a></li>
            <li class="nav-item"><a href="#tt" class="nav-link" data-toggle="tab">TimeTables</a></li>
        </ul>

        <div class="tab-content">
            <div class="tab-pane fade show active" id="cl">
                 @include('pages.support_team.classes.index')
            </div>

            {{-- Sections --}}
            <div class="tab-pane fade" id="sec">
                @include('pages.support_team.sections.index')
            </div>

            {{-- Subject --}}
            <div class="tab-pane fade" id="sub">
                @include('pages.support_team.subjects.index')
            </div>

            {{-- dorm --}}
            <div class="tab-pane fade" id="dorm">
                @include('pages.support_team.dorms.index')
            </div>
                                    ...
                                    <form class="ajax-store" method="post" action="{{ route('ttr.store') }}">
                                        ...
                                        <div class="form-group row">
                                            <label for="my_class_id"
                                                class="col-lg-3 col-form-label font-weight-semibold">Class
